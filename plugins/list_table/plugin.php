...
/*
Plugin Name: WP_List_Table Class
Plugin URI: https://lyenpon.fr/
Description: Liste les entrés dans une table custom de wordpress
Version: 1.0
Author: Yen-Pon Laurent
Author URI:  https://lyenpon.fr/
*/
...
class entries_List extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( [
			'singular' => __( 'Entrée', 'sp' ), //singular name of the listed records
			'plural'   => __( 'Entrées', 'sp' ), //plural name of the listed records
	...
	public function no_items() {
		_e( 'Aucunes données à afficher.', 'sp' );
	}
...
class SP_Plugin {
	...
	public function plugin_settings_page() {
		?>
		<div class="wrap">
			<h2>Liste des entrées custom</h2>
